...
describe('Validate TS configs', () => {
  it('Validate eslint-config-xjy/typescript', async () => {
  ...
  it('Validate eslint-config-xjy/typescript/vue', async () => {
  ...
  it('Validate eslint-config-xjy/essential/typescript', async () => {
  ...
  it('Validate eslint-config-xjy/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-xjy/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-xjy/typescript/node', async () => {
