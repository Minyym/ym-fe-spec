...
describe('Validate TS configs', () => {
  it('Validate eslint-config-ym/typescript', async () => {
  ...
  it('Validate eslint-config-ym/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ym/essential/typescript', async () => {
  ...
  it('Validate eslint-config-ym/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-ym/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ym/typescript/node', async () => {
