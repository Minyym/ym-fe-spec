...
describe('Validate JS configs', () => {
  it('Validate eslint-config-ym', async () => {
  ...
  it('Validate eslint-config-ym/es5', async () => {
  ...
  it('Validate eslint-config-ym/vue', async () => {
  ...
  it('Validate eslint-config-ym/essential', async () => {
  ...
  it('Validate eslint-config-ym/essential/es5', async () => {
  ...
  it('Validate eslint-config-ym/essential/react', async () => {
  ...
  it('Validate eslint-config-ym/essential/vue', async () => {
  ...
  it('Validate eslint-config-ym/node', async () => {
