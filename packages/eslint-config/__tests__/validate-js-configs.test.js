...
describe('Validate JS configs', () => {
  it('Validate eslint-config-xjy', async () => {
  ...
  it('Validate eslint-config-xjy/es5', async () => {
  ...
  it('Validate eslint-config-xjy/vue', async () => {
  ...
  it('Validate eslint-config-xjy/essential', async () => {
  ...
  it('Validate eslint-config-xjy/essential/es5', async () => {
  ...
  it('Validate eslint-config-xjy/essential/react', async () => {
  ...
  it('Validate eslint-config-xjy/essential/vue', async () => {
  ...
  it('Validate eslint-config-xjy/node', async () => {
